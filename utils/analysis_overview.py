...
def get_social_media_matrix(
    ...
    social_media_indices = [channel_to_index[ch] for ch in social_media_channels]
    non_social_media_indices = [channel_to_index[ch] for ch in non_social_media_channels]
    all_indices = [channel_to_index[ch] for ch in all_channels]
            ...
            "social_media_interactions": {
                "sum": {
                    "script": {
                        "source": """
                        int interactions = 0;
                        if (doc.containsKey('likes') && doc['likes'].value != null) {
                            interactions += doc['likes'].value;
                        }
                        if (doc.containsKey('comments') && doc['comments'].value != null) {
                        ...
                        if (doc.containsKey('replies') && doc['replies'].value != null) {
                            interactions += doc['replies'].value;
                        }
                        if (doc.containsKey('favorites') && doc['favorites'].value != null) {
                            interactions += doc['favorites'].value;
                        }
                        if (doc.containsKey('votes') && doc['votes'].value != null) {
